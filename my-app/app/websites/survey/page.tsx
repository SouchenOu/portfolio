  ...
  return (
    <div className="flex flex-col items-center justify-center bg-gradient-to-b from-gray-800 to-gray-900 min-h-screen px-4 py-6">
      ...
      <h1 className="text-4xl text-purple-500 font-bold mb-8 text-center animate__animated animate__fadeIn">
        Hotjar surveys application
      </h1>

      {/* Image Carousel */}
      <div className="relative w-full max-w-[1700px] h-[900px] overflow-hidden rounded-lg shadow-2xl lg:block hidden">
      <Image
      ...
      <div className="mt-10">
        <a
          href="https://surveys.netlify.app/"
          target="_blank"
