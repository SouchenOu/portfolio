  ...
  return (
    <div className="flex flex-col items-center justify-center bg-gray-900 min-h-screen px-6 py-8">
      ...
      <h1 className="text-4xl text-purple font-semibold mb-6 text-center animate__animated animate__fadeIn">
        Welcome to the Whatsup Website
      </h1>

      {/* Image Carousel */}
      <div className="relative w-full max-w-[2500px] h-[1200px] overflow-hidden rounded-xl shadow-lg">
        <img
          src={images[currentIndex]}
          alt={`Texting Image ${currentIndex + 1}`}
      ...
      <div className="mt-8 p-4 text-center">
        ...
        >
          ...
          <span className="flex gap-2 text-3xl font-medium">
            ...
            <span className="underline text-violet-900">{'https:/WhatsupWebsite.com'}</span>
          </span>
        </a>
      </div>
    </div>
