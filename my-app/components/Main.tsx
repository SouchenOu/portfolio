    ...
    <div className='pb-20 pt-36'>
      ...
      <div className='flex justify-center relative my-20 z-10'>
        <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
          <h2 className='uppercase tracking-widest text-[26px] text-center text-blue-100 max-w-80'>Welcome.</h2>
          <TextGenerateEffect className="text-center text-[30px] md:text-5xl lg:text-6xl" words="Hi, My name is Ouchen Soukaina"/>
          <p className='text-center md:tracking-wider text-[17px] mb-4'>
