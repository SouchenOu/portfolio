...
export const Button = ({title, icon, position, handleClick, otherClasses} : {title: string; icon: React.ReactNode; position: string; handleClick?: () => void; otherClasses?:string}) => {
  return (
    <button className="relative  flex items-start justify-center  overflow-hidden rounded-full p-[2px] lg:h-[50px] md:w-60 w-[200px] md:mt-10 focus:outline-none " onClick={handleClick}>
